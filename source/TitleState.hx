...
class TitleState extends MusicBeatState
{
	...
	var ngSpr:FlxSprite;
	var judass:FlxSprite;
	
	var titleTextColors:Array<FlxColor> = [0xFF260000, 0xFFA10202];
	...
	function startIntro()
	{
		...
		judass = new FlxSprite(430, FlxG.height * 0.52);
		judass.frames = Paths.getSparrowAtlas('judas');	
		add(judass);
		judass.visible = false;
		judass.antialiasing = ClientPrefs.globalAntialiasing;
		judass.animation.addByPrefix('spin', 'spin', 24, true);
		judass.animation.play('spin');
		judass.updateHitbox();
	...
	function createCoolText(textArray:Array<String>, ?offset:Float = 0)
	{
		for (i in 0...textArray.length)
		{
			...
			money.setFormat("Schluber", 48, FlxColor.RED, CENTER);
	...
	function addMoreText(text:String, ?offset:Float = 0)
	{
		if(textGroup != null && credGroup != null) {
			...
			coolText.setFormat("Schluber", 48, FlxColor.RED, CENTER);
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					...
					#else
					createCoolText(['BanduFlower', 'LateralXYZ', 'M23', 'and more']);
					#end
				...
				case 7:
					...
					#end
				case 8:
					addMoreText('our awesome 3d dead forest team', -40);
					ngSpr.visible = true;
				// credTextShit.text += '\nNewgrounds';
				case 9:
					deleteCoolText();
				...
				case 15:
					judass.visible = true;
					createCoolText(['#3ddeadforestsweep'], -85);
					createCoolText(['#3ddeadforestsweep'], -45);
					createCoolText(['#3ddeadforestsweep'], -15);
					
					
				case 16:
					createCoolText(['#3ddeadforestsweep'], 35);
					createCoolText(['#3ddeadforestsweep'], 75);
					createCoolText(['#3ddeadforestsweep'], 115);
				...
				case 19:
					createCoolText(['Dave and Bambi By'], -65);				
								
					
				case 20:
					createCoolText(['DNB Team', 'and their', 'wonderful contributors!']);
				...
				// credTextShit.text += '\nNight';
				case 32:
					addMoreText('Forest'); // credTextShit.text += '\nFunkin';
