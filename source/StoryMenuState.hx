...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var bgYellow:FlxSprite = new FlxSprite(0, 56).makeGraphic(FlxG.width, 386, 0xFF7F0000);
		bgSprite = new FlxSprite(0, 56);
		bgSprite.antialiasing = ClientPrefs.globalAntialiasing;


		var blackBarThingie:FlxSprite = new FlxSprite(0, 0).loadGraphic(Paths.image('lowerblock'));
		add(blackBarThingie);

		
		var blackTop:FlxSprite = new FlxSprite().makeGraphic(FlxG.width, 56, FlxColor.BLACK);
